      ...
      >
        {scopeOptions.map((option) => (
          <button
            ...
            className={`min-h-9 rounded-full border px-3 text-[0.72rem] font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 ${
              scope === option.value
