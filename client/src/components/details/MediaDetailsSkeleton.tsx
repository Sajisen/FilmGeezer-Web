    ...
    >
      ...
      <MediaDetailsContainer className="py-10 sm:py-12">
        ...
        <div className="mt-12 rounded-3xl border border-white/10 bg-white/[0.04] p-5 sm:p-6 lg:p-8">
          ...
          <div className="skeleton-placeholder mt-3 h-7 w-48 rounded-md" />

          <div className="skeleton-placeholder mt-3 h-4 w-full max-w-xl rounded-md" />

          <div className="mt-6 grid gap-5 lg:grid-cols-[minmax(0,1fr)_18rem]">
            <div>
              <div className="skeleton-placeholder aspect-video min-h-[200px] rounded-2xl" />

              <div className="mt-4 flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1 space-y-2">
                  <div className="skeleton-placeholder h-4 w-3/5 rounded-md" />

                  <div className="skeleton-placeholder h-3 w-2/5 rounded-md" />
                </div>

                <div className="skeleton-placeholder h-11 w-36 rounded-full" />
              </div>
            </div>

            <div className="hidden rounded-2xl border border-white/10 bg-slate-950/45 p-4 lg:block">
              ...
              <div className="mt-4 space-y-3">
                {Array.from({
                  ...
                  >
                    ...
                    <div className="skeleton-placeholder mt-3 h-4 w-full rounded-md" />
