...
const MULTIPLE_WHITESPACE_PATTERN =
  /\s+/gu;
...
const emailVerificationChallengeIdSchema =
  z.uuid({
    version: "v4",
...
export const emailVerificationInputSchema =
  z
    .object({
      challengeId:
