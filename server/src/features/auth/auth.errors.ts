...
export class AuthAccountConflictError
  extends Error {
  readonly code =
...
export class AuthWeakPasswordError
  extends Error {
  readonly code =
    "AUTH_WEAK_PASSWORD";
...
export class AuthPersistenceError
  extends Error {
  readonly code =
...
export class AuthEmailConfigurationError
  extends Error {
  readonly code =
    "AUTH_EMAIL_CONFIGURATION_ERROR";
...
export class AuthEmailDeliveryError
  extends Error {
  readonly code =
    "AUTH_EMAIL_DELIVERY_ERROR";
...
export class AuthEmailVerificationError
  extends Error {
  readonly code =
...
export class AuthEmailVerificationResendError
  extends Error {
  readonly code =
